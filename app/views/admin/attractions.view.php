            ...
            <div id="top-districts-section" class="content-section">
                <div class="attractions-list">
                    <?php foreach ($districts as $district): ?>
                        <div class="attraction-card" data-district-name="<?= htmlspecialchars(strtolower($district->district_name)) ?>">
                            <div class="attraction-header">
                                <h3><?= htmlspecialchars($district->district_name) ?></h3>
                            </div>
                            <div class="attraction-preview">
                                <?php if (isset($district->coverPic)): ?>
                                    <img src="<?= ROOT . '/' . $district->coverPic ?>" alt="<?= htmlspecialchars($district->district_name) ?>" class="preview-image">
                                <?php else: ?>
                                    <img src="<?= ROOT ?>/assets/images/default-district.jpg" alt="Default District Image" class="preview-image">
                                <?php endif; ?>
                ...
                <div class="action-panel">
                    <div class="filter-container">
                        ...
                        <select id="district-filter" name="district_id" onchange="filterByDistrict(this.value)">
                            ...
                            <?php foreach ($districts as $district): ?>
                                <option value="<?= $district->district_id ?>" <?= ($selectedDistrict == $district->district_id) ? 'selected' : '' ?>>

    ...
    <div class="mainContainer">
        ...
        <div class="leftPanel">
            ...
            <div id="activeLink" class="linkHolder">
                <a href="<?= ROOT ?>/traveler/RegisteredTravelerHome" class="linkItem" style="color:#002D40 ;"><i
        ...
        <div class="rightContainer">
            ...
            <div class="contentContainer">
                ...
                <p class="subHead">
                    Join expert-led adventures and discover hidden gems across Sri Lanka. Find the perfect tour for your
                    next journey!
                </p>
                <div class="imageContainer">
            ...
            <div class="contentContainer">
                ...
                <p class="subHead">
                    Discover your destination at your own pace with our reliable car rentals. Flexible options, great
                    rates!
                </p>
                <div class="imageContainer">

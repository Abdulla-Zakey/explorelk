    ...
    <header>
        <nav class="navbar">
            ...
            <div class="backToHome">
                <a  href="<?= ROOT ?>/traveler/ParticularDistrictUnreg/index/<?= $district_id ?>">
            ...
            <ul class="nav-links">
                ...
                <li><a href = "<?= ROOT ?>/traveler/Login" target = "_blank">Find a Hotel</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login" target = "_blank">Rent a Car</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login" target = "_blank">Restaurants</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login" target = "_blank">Join a Tour</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login" target = "_blank">Upcoming Events</a></li>
            </ul>
            ...
            <div class = "slider">
                ...
                <?php 
                    ...
                    if (!empty($attractionPictures)) {
                        ...
                        echo '<img id="slide1" src="' . ROOT . '/assets/images/travelers/imagesNotFound.png">';

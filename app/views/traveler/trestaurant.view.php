...
<body>
  ...
  <div class="container">
        <section class="profile-section">
            <div class="profile-picture">
                <img src="https://via.placeholder.com/128" alt="La Bella Cucina Profile">
            </div>
            <h1 class="restaurant-name">La Bella Cucina</h1>
            ...
            <div class="location">
                ...
                <span>Via Roma 123, Florence, Italy</span>
            </div>
            ...
            <div class="carousel-container">
                ...
                <div class="carousel" id="imageCarousel">
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Restaurant interior">
                    </div>
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Chef preparing pasta">
                    </div>
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Outdoor seating">
                    </div>
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Wine cellar">
                    </div>
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Tiramisu dessert">
                    </div>
                    <div class="carousel-item">
                        <img loading="lazy" src="https://via.placeholder.com/600x400" alt="Fresh ingredients">
                    </div>
                </div>
        ...
        <section class="details-section">
            <article class="about-card">
                ...
                <p class="about-text">La Bella Cucina offers an authentic Italian dining experience in the heart of Florence. Our chefs use fresh, local ingredients to craft traditional dishes with a modern twist, paired with an extensive selection of regional wines.</p>
            </article>
            <div class="info-cards">
                ...
                <article class="info-card">
                    ...
                    <ul class="contact-list">
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24"><path d="M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.24 1.02l-2.2 2.2z"/></svg>
                            <span>+39 055 123 4567</span>
                        </li>
                        <li>
                            <svg width="16" height="16" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/></svg>
                            <span>www.labellacucina.it</span>
                        </li>
                    </ul>
                </article>
            </div>
  ...
  <div class="modal" id="reservation-modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="reservation-form" class="form" action="<?= ROOT ?>/traveler/trestaurant/reserve" method="POST">
  ...
  <div class="modal" id="cancel-modal">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure you want to cancel this reservation? Cancellations within 24 hours of the reservation time may not be allowed.</p>
        <div class="form-buttons">
          <button class="btn btn-outline" id="keep-reservation-btn">Keep Reservation</button>
          <form id="cancel-reservation-form" action="<?= ROOT ?>/traveler/trestaurant/cancelReservation" method="POST" style="display: inline;">
    ...
    function initModalHandlers() {
      ...
      document.getElementById('reservation-form').addEventListener('submit', function(e) {
        ...
        if (hasError) {
          ...
          console.log('Form validation passed, submitting to:', '<?= ROOT ?>/traveler/trestaurant/reserve');
        }
      });
      ...
      document.getElementById('cancel-reservation-form').addEventListener('submit', function(e) {
        ...
        if (!reservationId) {
          ...
          console.log('Cancel form validation passed, submitting to:', '<?= ROOT ?>/traveler/trestaurant/cancelReservation');
        }
      });
    }

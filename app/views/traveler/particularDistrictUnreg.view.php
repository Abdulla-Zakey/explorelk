...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                ...
                <li><a href = "<?= ROOT ?>/traveler/Login">Restaurants</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login">Join a Tour</a></li>
                <li><a href = "<?= ROOT ?>/traveler/Login">Upcoming Events</a></li>
            </ul>
        </nav>
    </header>
    ...
    <div class="detailsContainer">
        ...
        <div class="imageContainer">
            ...
            ?>
                <div class="<?= $position ?>">
                    <a href="<?= ROOT ?>/traveler/LoadAttractionsDetailsUnreg/index/<?= $attraction->attraction_name ?>" title="Click here to view more details">

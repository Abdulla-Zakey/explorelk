                    ...
                    <div class="longInputs" style="display: flex;">
                     ...
                     <div class="longInputs">
                        ...
                        <div class="itenerary-Conatiner">
                            ...
                            <input type = "text" name = "placeToVisit" id = "placeToVisit" placeholder = "Eg. Victoria Park, Nuwara Eliya">
    ...
    <script>
        ...
        function handleAddPlace(event) {
            ...
            if (currentPlaces < 3) {
                ...
                if (currentPlaces + 1 >= 3) {
                    event.target.style.display = 'none';
                }
        
                // Initialize Google Places Autocomplete for new place input
                const newPlaceInput = newPlaceActivity.querySelector('input[name="placeToVisit"]');
        ...
        function handleAddDay(event) {
            ...
            if (currentDays < diffDays) {
                ...
                const newAccommodationInput = newDay.querySelector('input[name="accommadation"]');
                const newPlaceInput = newDay.querySelector('input[name="placeToVisit"]');
                new google.maps.places.Autocomplete(newAccommodationInput, {
                    componentRestrictions: { country: 'LK' }
                });
                new google.maps.places.Autocomplete(newPlaceInput, {
                    componentRestrictions: { country: 'LK' }

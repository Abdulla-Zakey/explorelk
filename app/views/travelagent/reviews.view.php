...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/travelagent/reviews.css?v=1.2">
</head>
<body>
    <main>
        <div class="reviews-container">
            <header>
                ...
                <?php if ($data['total_reviews'] > 0): ?>
                    <h3>Average Rating: <?= number_format($data['average_rating'], 1) ?> / 5 (<?php if(isset($data['stats']) && isset($data['stats']['total_reviews'])): ?><?= $data['stats']['total_reviews'] ?><?php else: ?>0<?php endif; ?> reviews)</h3>
                <?php else: ?>

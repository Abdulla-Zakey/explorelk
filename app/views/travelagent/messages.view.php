...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/assets/css/travelagent/messages.css?v=1.3">
...
<body>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function addMessage(message) {
            ...
            messageDiv.className = `message ${message.sender_type === 'travelagent' ? 'sent' : 'received'}`;
        ...
        function sendMessage() {
            if (!selectedTravelagentId || !selectedTravelerId || isMessageSending) return;
        ...
        function setupEventListeners() {
            ...
            document.querySelectorAll('.contact').forEach(contact => {
                contact.addEventListener('click', () => {
                    const travelagentId = contact.dataset.travelagentId;
                    const travelerId = contact.dataset.travelerId;
                    const travelerName = contact.dataset.travelerName;
                    loadChat(travelagentId, travelerId, travelerName, contact);
                });
            });
        ...
        if (selectedTravelagentId || 'travelagent_id' in window.sessionStorage) {
            updateUnreadCounts();
        }

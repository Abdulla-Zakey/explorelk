...
<body>
    <div class="container">
        <div class="form-container">
            <form id="multiStepForm" method="POST" action="<?=ROOT?>/Signup/C_SignUp">
                <!-- Step 1 -->
                <div class="form-step active">
                    ...
                    <div>
                        <input id="name" name="guideName" type="text" required>
                        <?php if(!empty($errors)):?>
                            <div>
                                <?=$errors['yourName']?>
                            </div>
                    ...
                    <div>
                        <input id="email" name="guideEmail" type="email" required>
                        <?php if(!empty($errors)):?>
                            <div>
                                <?=$errors['email']?>
                            </div>
                    ...
                    <div>
                        <input id="password" name="guidePassword" type="password" required/>
                        <?php if(!empty($errors)):?>
                            <div>
                                <?=$errors['password']?>
                            </div>
                ...
                <div class="form-step">
                    ...
                    <div>
                        <input id="contact-number" name="guideMobileNum" type="text" required/>
                        <?php if(!empty($errors)):?>
                            <div>
                                <?=$errors['guideMobileNum']?>
                            </div>
                        <?php endif;?>
                    </div>
                    ...
                    <div>
                        <input id="address" name="guideAddress" type="text" required/>
                        <?php if(!empty($errors)):?>
                            <div>
                                <?=$errors['guideAddress']?>
                            </div>

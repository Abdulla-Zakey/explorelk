<html>
 ...
 <body>
    <main>
        ...
        <div class="image-container">
            <img alt="Hotel entrance with greenery and lights" src="<?php echo ROOT; ?>/assets/images/resturant/restCover.jpg"/>
            <div class="title">
                Royal Bakery
            </div>
        </div>
        <div class="date" id="hcurrent-date"></div>
 ...
 <script>
    ...
    document.getElementById('hcurrent-date').textContent = formattedDate;

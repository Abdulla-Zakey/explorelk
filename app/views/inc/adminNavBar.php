<div class = "leftPanel">
    ...
    <div class = "linkHolder">
        <a href = "<?= ROOT?>/admin/C_newRegistrations" class = "linkItem"><i class="fa-solid fa-user-plus"></i>New Registrations</a>
    </div>
    
    <div class = "linkHolder">
        <a id="bookingsLink" class = "linkItem"><i class="fas fa-calendar-check"></i>Bookings</a>
    ...
    <div class="linkHolder">
        <a href="#" id="earningsLink" class="linkItem">
    ...
    <div class="linkHolder">
        <a href="#" id="usersLink" class="linkItem">
    ...
    <div class = "linkHolder">
        <a href = "<?= ROOT?>/admin/C_contentManagement" class = "linkItem"><i class="fas fa-file-alt"></i>Content Management</a>
    </div>
    ...
    <div class = "linkHolder">
        <a href = "<?= ROOT?>/admin/C_adminSignIn" class = "linkItem"><i class="fas fa-sign-out-alt"></i>Logout</a>
    </div>
</div>

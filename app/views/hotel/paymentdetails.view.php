<?php 
    ...
    $totalCommission = $data['totalCommission'] ?? 0; // Ensure totalCommission is defined
    $commissionToPay = $totalCommission - $totalApprovedCommission - $totalPendingCommission;

    // Set current month and year for filter
...
<head>
    ...
    <link rel="stylesheet" href="<?= ROOT ?>/public/css/paymentdetails.css">
...
<body>
        ...
        <div class="container">
            ...
            <div class="payment-summary">
                <div class="summary-card">
                    <h3>Total Revenue</h3>
                    <p class="amount">LKR <?= number_format($data['totalRevenue'] ?? 0, 2) ?></p>
                </div>
                <div class="summary-card">
                    <h3>Current Month Revenue</h3>
                    <p class="amount">LKR <?= number_format($data['currentMonthRevenue'] ?? 0, 2) ?></p>
                </div>
                <div class="summary-card">
                    <h3>Current Month Commission</h3>
                    <p class="amount">LKR <?= number_format($data['currentMonthCommission'] ?? 0, 2) ?></p>
                </div>
            </div>

            <!-- Filter Controls -->
            <div class="filter-controls">
                <form method="GET" action="<?= ROOT ?>/Hotel/Hpaymentdetails" class="filter-form" id="filterForm">
                    <div class="form-group">
                        ...
                        <select name="month" id="month">
                            ...
                            <option value="<?= sprintf('%02d', $i) ?>"
                                <?= $currentMonth == sprintf('%02d', $i) ? 'selected' : '' ?>>
                    ...
                    <a href="<?= ROOT ?>/Hotel/Hpaymentdetails" class="btn btn-reset">Reset</a>
                </form>
            </div>
            ...
            <div class="payment-earning-container">
                ...
                <div id="payment-history" class="tab-content">
                    ...
                    <div class="earnings-commission-payment">
                        <div class="earnings-payment-info">
                            ...
                            <span class="earnings-payment-amount">Rs <?= number_format($rejectamount, 2) ?></span>
                        </div>
                            ...
                            <tr>
                                ...
                                <!-- <td>
                                    <button class="btn-view"
                                        onclick="viewBookingDetails(<?= $payment->room_booking_Id ?>)">View</button>
                                </td> -->
                            </tr>
                            <?php endforeach; ?>
                            <?php else: ?>
                ...
                <div id="earning" class="tab-content active">
                    ...
                    <table class="earning-table">
                        ...
                        <tbody>
                            <?php if (!empty($data['earning'])): ?>
                            <?php foreach ($data['earning'] as $earning): ?>
                            <tr>
                                <td><?= date('Y-m-d', strtotime($earning->requested_date)) ?></td>
                                <td><?= $earning->room_booking_Id ?></td>
                                <td>LKR <?= number_format($earning->total_amount, 2) ?></td>
                                <td>LKR
                                    <?= number_format(property_exists($earning, 'advance_payment_amount') ? $earning->advance_payment_amount : 0, 2) ?>
                                </td>
                                <td>
                                    <span class=""><?= htmlspecialchars($earning->booking_status) ?></span>
                                </td>
                                <!-- <td>
                                    <button class="btn-view"
                                        onclick="viewBookingDetails(<?= $earning->room_booking_Id ?>)">View</button>
                                </td> -->
                            </tr>
                            <?php endforeach; ?>
                            <?php else: ?>
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-grid">
                            <div class="info-item">
                                ...
                                <span id="guestName" class="value">Kumara Sangakara</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Email</span>
                                <span id="guestEmail" class="value">kumarsanga@gmail.com</span>
                            </div>
                            <div class="info-item">
                                <span class="label">Phone</span>
                                <span id="guestPhone" class="value">0779984032</span>
                            </div>
                            <div class="info-item">
                    ...
                    <div class="info-section">
                        ...
                        <div class="info-grid">
                            ...
                            <div class="info-item">
                                ...
                                <span id="roomType" class="value">Single Type</span>
                            </div>
                            <div class="info-item full-width">
                                <span class="label">Special Requests</span>
                                <span id="specialRequests" class="value">Early check-in if possible. Need an extra
                                    pillow.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-section">
                        ...
                        <div class="price-summary">
                            <div class="price-item">
                                <span id="roomRate">Room Rate (5 nights × RS.5,000.00)</span>
                                <span id="roomRateTotal">RS.25,000.00</span>
                            </div>
                            <div class="price-item">
                                <span>Resort Fee</span>
                                <span id="resortFee">RS.5,000.00</span>
                            </div>
                            <!-- <div class="price-item">
                                <span id="taxRate">Taxes (12%)</span>
                                <span id="taxAmount">RS.600.00</span>
                            </div> -->
                            <div class="price-total">
                                <span>Total</span>
                                <span id="totalAmount">RS.25,000.00</span>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function viewBookingDetails(bookingId) {
        ...
        // Optionally fetch booking details via AJAX if needed
    }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        filterForm.addEventListener('submit', function(event) {
            ...
            if (!month && !year) {
                // Allow submission with no filters to show all data
                return;
            }
            if (month && !year) {
            ...
            if (!month && year) {
                alert('Please select a month when filtering by year.');
                event.preventDefault();
                return;
            }
        });

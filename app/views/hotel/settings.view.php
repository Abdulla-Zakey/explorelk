...
<body>
    ...
    <main>
        <div class="container">
            <h1>My Account</h1>
            <form id="accountForm" action="<?= ROOT ?>/Hotel/Hsettings/update" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea id="description1" name="description[0]" placeholder="Write about your Hotel" readonly><?= htmlspecialchars($data['hotelBasic']->description_para1) ?></textarea>
        <div class="error" id="description-error1"></div>
        <textarea id="description2" name="description[1]" placeholder="Write about your Hotel" readonly><?= htmlspecialchars($data['hotelBasic']->description_para2) ?></textarea>
        <div class="error" id="description-error2"></div>
        <textarea id="description3" name="description[2]" placeholder="Write about your Hotel" readonly><?= htmlspecialchars($data['hotelBasic']->description_para3) ?></textarea>

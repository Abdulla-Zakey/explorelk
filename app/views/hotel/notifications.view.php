        ...
        <div class="booking-filters">
            <div class="filter-item">
                ...
                <select id="date-filter" onchange="applyFilters()">
                    <option value="newest" <?= ($data['currentSort'] ?? '') === 'newest' ? 'selected' : '' ?>>Newest
                        First</option>
                    <option value="oldest" <?= ($data['currentSort'] ?? '') === 'oldest' ? 'selected' : '' ?>>Oldest
                        First</option>
            ...
            <div class="filter-item">
                ...
                <select id="status-filter" onchange="applyFilters()">
                    <option value="all" <?= ($data['currentStatus'] ?? '') === 'all' ? 'selected' : '' ?>>All Statuses
                    </option>
                    <option value="Pending" <?= ($data['currentStatus'] ?? '') === 'Pending' ? 'selected' : '' ?>>
                        Pending</option>
                    <option value="Approved" <?= ($data['currentStatus'] ?? '') === 'Approved' ? 'selected' : '' ?>>
                        Approved</option>
                    <option value="Confirmed" <?= ($data['currentStatus'] ?? '') === 'Confirmed' ? 'selected' : '' ?>>
                        Confirmed</option>
                    <option value="Cancelled" <?= ($data['currentStatus'] ?? '') === 'Cancelled' ? 'selected' : '' ?>>
                        Cancelled</option>
                </select>
            </div>
                ...
                <div class="booking-content">
                    ...
                    <div class="payment-details">
                        ...
                        <div class="payment-flex">
                            ...
                            <span
                                class="payment-value">Rs.<?= esc(number_format($booking->total_amount ?? 0, 2)) ?></span>
                        </div>
                        <div class="payment-flex">
                            <span class="payment-label">Advance Payment Required:</span>
                            <span
                                class="payment-value">Rs.<?= esc(number_format($booking->advance_payment_amount ?? 0, 2)) ?></span>
                        </div>
                        <div class="payment-flex">

    ...
    <div class="custom-modal" id="tableModal">
        <div class="custom-modal-content">
            ...
            <button class="custom-close-btn" onclick="closeModal()">&times;</button>
                ...
                <tbody>
                    <tr>
                        <td class="custom-td">S01</td>
                        <td class="custom-td">Rs 2000.00</td>
                        <td class="custom-td">Luxury room with ocean view</td>
                        <td class="custom-td"><button class="enhanced-button" onclick="viewPhotos()"><i class="fas fa-image custom-icon"></i>View Photos</button></td>
                        <td class="custom-td">
                    ...
                    <tr>
                        <td class="custom-td">S02</td>
                        <td class="custom-td">Rs 2500.00</td>
                        <td class="custom-td">Luxury room with ocean view</td>
                        <td class="custom-td"><button class="enhanced-button" onclick="viewPhotos()"><i class="fas fa-image custom-icon"></i>View Photos</button></td>
                        <td class="custom-td">

                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    ...
                                    <a href="<?= ROOT ?>/Hotel/Test/viewRoomTypeDetails/<?= $type->hotel_roomType_Id ?>">
            ...
            <div id="roomTypeInfo" class="tab-content active">
                <div class="room-type-details">
                    <div class="room-image-container">
                        <img src="<?= ROOT ?>/<?= $roomTypeDetails->thumbnail_picPath ?>" 
                             alt="<?= $roomTypeDetails->roomType_name ?>" 
                             class="room-type-image">
                    </div>
                    <div class="details-grid">
                        <div class="detail-item">
                            <span class="detail-label">Room Type</span>
                            <span class="detail-value"><?= $roomTypeDetails->roomType_name ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Price per Night</span>
                            <span class="detail-value">Rs.<?= number_format($roomTypeDetails->pricePer_night, 2) ?></span>
                        </div>
                        <div class="detail-item">
                            <span class="detail-label">Max Occupancy</span>
                            <span class="detail-value"><?= $roomTypeDetails->max_occupancy ?> Guests</span>
                        </div>
                        <div class="detail-item full-width">
                            <span class="detail-label">Description</span>
                            <p class="detail-value"><?= $roomTypeDetails->customized_description ?></p>
                        </div>
                        <div class="detail-item full-width">
                ...
                <div class="rooms-grid">
                    <?php foreach($rooms as $room): ?>
                        <div class="room-card">
                            ...
                            <div class="room-status <?= strtolower($room->status ?? 'available') ?>">
                                <?= $room->status ?? 'Available' ?>
                            </div>
                        </div>
                    <?php endforeach; ?>

...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ROOT; ?>/assets/css/Traveler/footerNew.css">
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-content">
                        ...
                        <li><a href="<?= ROOT ?>/eventorganizer/eosignup">Sign Up as an Event Organizer</a></li>
                    </ul>
                </li>
    ...
    <div class="footerContainer">
        ...
        <div class="followUS">
            ...
            <div class="followUS-description">
                Stay connected and up-to-date with the latest travel tips, destination highlights, 
                and special offers. Join our community of travel enthusiasts.
            </div>

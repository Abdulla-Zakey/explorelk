...
<script>
    function setupSearch() {
        ...
        const noEventsMessage = document.querySelector('.no-events') || document.createElement('p');
        ...
        searchInput.addEventListener('input', (e) => {
            ...
            eventCards.forEach(card => {
                const title = card.querySelector('.event-info h3').textContent.toLowerCase();
                const location = card.querySelector('.event-info p').textContent.toLowerCase();

<?php
    ...
    class ViewAccommodationBookingPaymentReceipt extends Controller{
    ...
    public function index($roomBookingId)
    {
        ...
        $data['qr_image'] = $booking->path_to_payment_confirmation_QR;
        
        
        $this->view('traveler/accommodationBookingAdvancePaymentTicket', $data);
    }

        ...
        <div class="form-container">
            ...
            <form id="multiStepForm" method="POST" action='<?= ROOT ?>/Signup/TourGuideSignup'>
                ...
                <div class="form-step">
                    ...
                    <input id = "experience" name = "experience" type="number" minimum = "0" required value="<?= isset($experience) ? htmlspecialchars($experience) : '' ?>">
                    ...
                    <input id="tourFrequencyPerMonth" name="tourFrequencyPerMonth" type="number" minimum = "1" required value="<?= isset($tourFrequencyPerMonth) ? htmlspecialchars($tourFrequencyPerMonth) : '' ?>">
